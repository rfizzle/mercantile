...
- Removing the pylon — mined, blown up, pushed, or `/setblock`'d away — immediately dismisses all of its sentries with the same crack-and-fade effect. They are temporary summons tied to their pylon, so none is left stranded once the block is gone.
