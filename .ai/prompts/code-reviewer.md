You are reviewing a pull request for the Mercantile Minecraft Fabric mod.
...
### ⚠ Conventions
- `src/main/java/com/rfizzle/mercantile/foo/Bar.java:42` — uses `nbt`-package
  name instead of Mojang `CompoundTag`.

### ✗ Mixin safety
- `src/main/java/com/rfizzle/mercantile/mixin/VillagerMixin.java:88` —
